...
public class BaseElement {
	...
	public TestObject xpath (TestObject to, String by = 'xpath',  String outerTag) {
		String newXPath = to.findPropertyValue(by)"${outerTag}"
		return new TestObject("objectName").addProperty("xpath", ConditionType.EQUALS, newXPath)
	}
}
