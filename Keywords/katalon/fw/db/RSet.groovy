...
public class RSet {
	 ...
	 */
	public getListCellValue (ResultSet rs, String columnName) throws SQLException{
	 ...
	 * @return List of string value
	 */
	public getListCellValue (ResultSet rs, int columnIndex) throws SQLException{
		List<String> listOfValue = new ArrayList<>();
		rs.beforeFirst();
		while (rs.next()) {
	 ...
	 */
	public getSingleCellValue(ResultSet rs, int rowIndex, int colIndex) throws SQLException{
	 ...
	 */
	public getRowCount(ResultSet rs) throws SQLException {
		rs.last();
		return  rs.getRow();
	}


	public getSingleRowValue(ResultSet rs, int rowIndex) throws SQLException{
		List<String> listOfValue = new ArrayList<>();
		rs.absolute(rowIndex)
	...
	public List getListRowValue(ResultSet rs, int fromRowIndex, int toRowIndex) throws SQLException{
	 ...
	 * @return a number      - An integer datatype
	 */
	public getColumnCount (ResultSet rs) throws SQLException {
	 ...
	 */
	public isEmptyResult (java.sql.ResultSet rs) throws SQLException{
		if (!rs.first() ) {
			return true
		}
		else {
	 ...
	 * @return a csv file
	 */
	public exportToCSV(java.sql.ResultSet rs, String pathFile) throws SQLException{
