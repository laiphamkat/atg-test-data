...
if (GlobalVariable.isNewUIScheduleEnabled) {
	...
	Page.nav(NewUIScheduleTestRunPopUp)
		.inputTestRunName("TS-CircleCI-${unique}")
		.clickScriptRepo()
...
def tearDownIfPassed() {	
	SeedingData.saveTestExecToGSheet('TEST-EXEC-TS-CIRCLE-CI-1')
}
