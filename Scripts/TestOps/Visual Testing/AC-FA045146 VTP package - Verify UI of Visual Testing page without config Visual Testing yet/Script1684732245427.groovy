...
'Verify Visual Baseline Collection tab is active and Visual Baseline Collection title is displayed, baseline collection button is clickabled, pro icon is displayed'
Page.nav(VisualBaselineCollectionPage).verifyVisualBaselineCollectionsTabIsActived()
									  ...
									  .verifyProIconIsDisplayed()
									  .clickToCreateBaselineCollectionButton()
									  .inputBaselineCollectionName('Test Name')
									  .clickCancelButton()
