...
'''
I. Verify that subscription reactivated change on DB should be run correctly
Pre-condition:
 - The 'Subscription Management' page is opening.
 - Had subscription active in Account and have status canceled

Steps:
1. Click on the Turn on Auto-Renewal button on Ellipsis menu [...]
